...
const TIER_TRANSLATIONS: Record<string, Record<string, string>> = {
  ...
  fr: {
    ...
    essential: "Essentiel",
    enterpriseDesc: "Vous bénéficiez du support dédié prioritaire. Vos tickets sont traités en priorité absolue.",
  ...
  ht: {
    ...
    essential: "Esansyèl",
    enterpriseDesc: "Ou benefisye sipò dedye priyorite. Tikè ou yo trete ak priyorite absoli.",
