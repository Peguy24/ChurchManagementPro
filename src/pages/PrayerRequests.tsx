...
import { Heart, HeartHandshake, Loader2, Lock, Mail, Phone, Trash2 } from 'lucide-react';
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <h1 className="text-xl sm:text-2xl font-semibold tracking-tight truncate">Prayer Requests</h1>
