...
export const PLAN_DETAILS = {
  essentiel: {
    ...
    price: 29.99,
    yearlyPrice: 305,
    priceId: "price_1TUhjWFTm4C7ouBeeJJFjU6H",
    yearlyPriceId: "price_1TUhlxFTm4C7ouBe3XTZHbE5",
    productId: "prod_UTf3WP0cKpe9nL",
  },
  professionnel: {
    name: "Professional", 
    price: 59.99,
    yearlyPrice: 612,
    priceId: "price_1TUhkAFTm4C7ouBe4gEfoISY",
    yearlyPriceId: "price_1TUhmQFTm4C7ouBeuvlNyb6t",
    productId: "prod_UTf4OlDmzUl7gM",
  },
  entreprise: {
    name: "Enterprise",
    price: 99.99,
    yearlyPrice: 1020,
    priceId: "price_1TUhkXFTm4C7ouBegvYgbfhy",
    yearlyPriceId: "price_1TUhnEFTm4C7ouBeA4qdh6Qd",
    productId: "prod_UTf4SPRIVqmMpJ",
  },
} as const;
