        ...
        <BrowserRouter>
          ...
          <TenantProvider>
            ...
            <Routes location={routeLocation}>
              ...
              <Route path="/members/cards" element={<ProtectedRoute><FeatureGate feature="memberCards" featureKey="memberCards" requiredPlan="professionnel"><MemberCards /></FeatureGate></ProtectedRoute>} />
              <Route path="/members/details" element={<ProtectedRoute><MemberDetails /></ProtectedRoute>} />
              <Route path="/members/photo-booth" element={<ProtectedRoute><PhotoBooth /></ProtectedRoute>} />
              ...
              <Route path="/finance" element={<ProtectedRoute><FeatureGate feature="advancedFinance" featureKey="financeDashboard" requiredPlan="professionnel"><FinancialDashboard /></FeatureGate></ProtectedRoute>} />
              ...
              <Route path="/settings/branding" element={<ProtectedRoute><FeatureGate feature="branding" featureKey="branding" requiredPlan="professionnel"><TenantBranding /></FeatureGate></ProtectedRoute>} />
