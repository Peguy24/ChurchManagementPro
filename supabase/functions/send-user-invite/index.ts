...
const translations: Record<string, Record<string, string>> = {
  fr: {
    ...
    footer: "Cet email a été envoyé par Church Management Pro.",
  ...
  en: {
    ...
    footer: "This email was sent by Church Management Pro.",
    admin: "Administrator",
    pastor: "Pastor",
    treasurer: "Treasurer",
    secretary: "Secretary",
  ...
  ht: {
    ...
    footer: "Imèl sa a te voye pa Church Management Pro.",
    admin: "Administratè",
    pastor: "Pastè",
    treasurer: "Trezorye",
    secretary: "Sekretè",
